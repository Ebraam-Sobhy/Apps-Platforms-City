...
import cubeImage from '/coursera.png';
    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16 md:pb-20">
        <div className="text-center space-y-6 sm:space-y-8">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#4682B4] leading-tight">
            Coursera
          </h1>
          <p className="text-base sm:text-2xl md:text-2xl text-white leading-relaxed max-w-4xl mx-auto">
            Coursera is an online learning platform that offers courses, professional certificates, and degrees from top universities and companies around the world.
          </p>
          <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2
            ...
            <div className="w-full">
              <div className="relative aspect-video overflow-hidden rounded-2xl border-2 border-gray-200 shadow-xl">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/UVNbdQcYH2k?si=LxxYvPfdxy3WTtlw"
                  title="Video 1"
                  frameBorder="0"
                  allowFullScreen
                />
            ...
            <div className="w-full">
              <div className="relative aspect-video overflow-hidden rounded-2xl border-2 border-gray-200 shadow-xl">
                <iframe
                  className="absolute inset-0 w-full h-full"
                  src="https://www.youtube.com/embed/OVOxlhm81ag?si=VlisEj42aJ3rqby1"
                  title="Video 2"
                  frameBorder="0"
                  allowFullScreen
                />
