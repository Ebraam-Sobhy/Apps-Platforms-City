...
import cubeImage from '/linkedin.png';
    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16 md:pb-20">
        <div className="text-center space-y-6 sm:space-y-8">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#0e76a8] leading-tight">
            LinkedIn
          </h1>
          <p className="text-base sm:text-2xl md:text-2xl text-white leading-relaxed max-w-4xl mx-auto">
            LinkedIn is a professional networking platform where users connect with others in their industry, share updates, and build their professional profiles.
          </p>
        </div>
        {/* Videos */}
        {/* Wrapper */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2
            ...
            <div className="w-full">
              <div className="relative aspect-video overflow-hidden rounded-2xl border-2 border-gray-200 shadow-xl">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/QU5BHmuK140?si=O5xFjIlfq8CM6ud-"
                  title="Video 1"
                  frameBorder="0"
                  allowFullScreen
                />
            ...
            <div className="w-full">
              <div className="relative aspect-video overflow-hidden rounded-2xl border-2 border-gray-200 shadow-xl">
                <iframe
                  className="absolute inset-0 w-full h-full"
                  src="https://www.youtube.com/embed/k3EywfEK02s?si=H_SoKN4yCpon0moj"
                  title="Video 2"
                  frameBorder="0"
                  allowFullScreen
                />
