...
import cubeImage from '/chatgpt.png';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16 md:pb-20">
        <div className="text-center space-y-6 sm:space-y-8">
          ...
          <p className="text-base sm:text-2xl md:text-2xl text-white leading-relaxed max-w-4xl mx-auto">
            ChatGPT is an AI language model developed by OpenAI, capable of understanding and generating human-like text to assist with a wide range of tasks.
          </p>
          <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2
            ...
            <div className="w-full">
              <div className="relative aspect-video overflow-hidden rounded-2xl border-2 border-gray-200 shadow-xl">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/40Kp_fa8vIw?si=lhNW7fHB6hNRI5Vy"
                  title="Video 1"
                  frameBorder="0"
                  allowFullScreen
                />
            ...
            <div className="w-full">
              <div className="relative aspect-video overflow-hidden rounded-2xl border-2 border-gray-200 shadow-xl">
                <iframe
                  className="absolute inset-0 w-full h-full"
                  src="https://www.youtube.com/embed/Gaf_jCnA6mc?si=OeP9NmP0UkqmlwSN"
                  title="Video 2"
                  frameBorder="0"
                  allowFullScreen
                />
